...
- [结题报告](#结题报告)
  ...
  - [项目背景和调研](#项目背景和调研)
    ...
    - [2.Ray框架的理论基础](#1ray框架的理论基础)
      - [2.1 Ray计算模型](#11-ray计算模型)
      - [2.2 Ray分布式调度器](#12-ray分布式调度器)
      - [2.3 Ray分布式对象存储器](#13-ray分布式对象存储器)
      - [2.4 Ray相对其他分布式框架的优势](#14-ray相对其他分布式框架的优势)
        - [2.4.1 Mapreduce](#141-mapreduce)
        - [2.4.2 Spark](#143-spark)
    - [3.Deepspeed ZERO 理论基础](#deepspeed-zero-理论基础)
      - [3.1 ZERO优化的三个级别](#21-zero优化的三个级别)
        - [3.1.1 ZeRO-1：](#211-zero-1)
        - [3.1.2 ZERO-2](#212-zero-2)
        - [3.1.3 ZERO-3](#213-zero-3)
    - [4. 零拷贝技术](#3-零拷贝技术)
  - [技术路线](#技术路线)
    - [1 Ray train的使用](#1-ray-train的使用)
    - [2 deepspeed zero的使用](#2-deepspeed-zero的使用)
    - [3 Ray+deepspeed的优势](#3-raydeepspeed的优势)
      - [3.1 深度学习优化能力](#1-深度学习优化能力)
      - [3.2 与Ray的协同作用](#2-与ray的协同作用)
    - [4 关于数据分发的尝试](#关于数据分发的尝试)
      - [4.1 研究思路](#研究思路)
      - [4.2 研究路线](#研究路线)
      - [4.3 核心代码讲解](#核心代码讲解)
      - [4.4 相关工作](#3-相关工作)
    - [5 Ray Serve的使用](#ray-serve的使用)
      - [5.1 Ray Serve介绍](#1-ray-serve介绍)
      - [5.2 环境介绍及测试思路](#2-环境介绍及测试思路)
  - [优化结果与分析](#优化结果与分析)
