...
- [结题报告](#结题报告)
  ...
  - [项目背景和调研](#项目背景和调研)
    ...
    - [1.Ray框架的理论基础](#1ray框架的理论基础)
      - [1.1 Ray计算模型](#11-ray计算模型)
      - [1.2 Ray分布式调度器](#12-ray分布式调度器)
      - [1.3 Ray分布式对象存储器](#13-ray分布式对象存储器)
      - [1.4 Ray相对其他分布式框架的优势](#14-ray相对其他分布式框架的优势)
        - [1.4.1 Mapreduce](#141-mapreduce)
        - [1.4.3 Spark](#143-spark)
    - [Deepspeed ZERO 理论基础](#deepspeed-zero-理论基础)
      - [2.1 ZERO优化的三个级别](#21-zero优化的三个级别)
        - [2.1.1 ZeRO-1：](#211-zero-1)
        - [2.1.2 ZERO-2](#212-zero-2)
        - [2.1.3 ZERO-3](#213-zero-3)
    - [3. 零拷贝技术](#3-零拷贝技术)
  - [技术路线](#技术路线)
